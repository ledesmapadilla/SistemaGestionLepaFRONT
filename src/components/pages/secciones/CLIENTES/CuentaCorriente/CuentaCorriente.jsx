...
const CuentaCorriente = () => {
  ...
  return (
    <div className="w-75 mx-auto my-2">
      <h6 className="text-center mb-1">Cuenta Corriente Cliente <small className="text-muted">(iva incluido)</small></h6>
          ...
          <div className="d-flex align-items-center gap-2">
            ...
            <div style={{ position: "relative", width: "260px" }}>
              <Form.Select
                ...
                style={filtroCliente ? { backgroundImage: "none", height: "34px" } : { height: "34px" }}
              >
            ...
            <div className="d-flex align-items-center gap-2">
              ...
              <div style={{ position: "relative", width: "260px" }}>
                <Form.Select
                  ...
                  style={filtroObra ? { backgroundImage: "none", height: "34px" } : { height: "34px" }}
                >
        ...
        {!loading && (filtroCliente ? movConSaldo.length : resumenFiltrado.length) > 0 ? (() => {
          ...
          return (
            <div className="d-flex gap-3">
              ...
              <div className="border border-warning rounded px-3 py-1 text-center" style={{ minWidth: "150px" }}>
