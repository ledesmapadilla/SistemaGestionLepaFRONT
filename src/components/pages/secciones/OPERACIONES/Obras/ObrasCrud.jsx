            ...
            {obrasFiltradas.length === 0 ? (
              ...
              obrasFiltradas.map((obra) => (
                <tr key={obra._id}>
                  ...
                  <td>{obra.contacto}</td>
                  <td style={{ whiteSpace: "nowrap" }} className={obra.estado === "Terminada +" ? "text-success" : (obra.estado === "Terminada -" || obra.estado === "Terminada (-)") ? "text-danger" : obra.estado === "Terminada, sin análisis" ? "text-primary" : ""}>{obra.estado}</td>
