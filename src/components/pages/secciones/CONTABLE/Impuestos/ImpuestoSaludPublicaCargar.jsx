...
export default function ImpuestoSaludPublicaCargar() {
  ...
  const exportarExcel = () => {
    const titulo = `Salud Pública - ${mesNombre} ${anio}`;
    ...
    FILAS.forEach(({ tipo, label }, idx) => {
      ...
      ws[`D${row}`] = { v: valor - pagado,   t: "n", s: { ...estCentro, ...moneda } };
    ...
    XLSXStyle.utils.book_append_sheet(wb, ws, "Salud Publica");
