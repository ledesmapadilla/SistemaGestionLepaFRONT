...
export default function ImpuestoAutonomosCargar() {
  ...
  const exportarExcel = () => {
    const titulo = `Autónomos - ${mesNombre} ${anio}`;
    ...
    XLSXStyle.utils.book_append_sheet(wb, ws, "Autónomos");
    ...
    <div className="container mt-4">
      <div className="w-100">
        <div className="d-flex justify-content-between align-items-center mb-4">
          <h2 className="mb-0">💀 Autónomos</h2>
