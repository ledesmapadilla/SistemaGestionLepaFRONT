          ...
          <tbody>
            {registros.length === 0 ? (
              ...
              registros.filter(r => {
                ...
                <tr key={r._id}>
                  <td style={r.maquinaLabel === "vendida" ? { textDecoration: "line-through", textDecorationColor: "red", color: "white" } : {}}>{r.bateria?.nombreBateria || "-"}</td>
                  <td style={r.maquinaLabel === "vendida" ? { textDecoration: "line-through", textDecorationColor: "red", color: "white" } : {}}>{r.maquinaLabel || r.maquina?.maquina || "-"}</td>
