...
const IconoExcavadora = ({ color, className }) => (
  <svg
    viewBox="0 0 122.88 100.89"
    width="1em"
    height="1em"
    fill={color}
    className={className}
...
const tarjetas = [
  ...
  {
    titulo: "Retropalas",
    icono: (props) => <IconoExcavadora {...props} />,
