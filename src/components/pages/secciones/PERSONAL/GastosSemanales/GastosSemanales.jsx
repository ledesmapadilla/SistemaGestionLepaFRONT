                    ...
                    <td className="text-start fw-semibold">
                      {r.nuevo ? (
                        ...
                        <span
                          ...
                          style={{ cursor: "pointer", userSelect: "none", color: r.marcado === 1 ? "#ffc107" : "#dee2e6", textDecoration: r.marcado === 2 ? "line-through" : "none", textDecorationColor: "#ffc107", textDecorationThickness: 1 }}
                        >
                          {r.personal}
                        </span>
                      )}
