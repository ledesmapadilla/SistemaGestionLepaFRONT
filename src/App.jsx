...
const ResumenEPP = lazy(() => import("./components/pages/secciones/PERSONAL/EntregaEPP/ResumenEPP.jsx"));
                ...
                <PendientesModalProvider>
                  ...
                  <main className="container-fluid px-0 pt-5 mt-5">
                    ...
                    <Routes>
                      ...
                      <Route path="/mantenimiento/cubiertas/camiones" element={<Cubiertas categoria="camiones" titulo="Cubiertas camiones y carretones - 295 x 22.5" />} />
                      ...
                      <Route path="/personal/entrega-epp/entregados" element={<ResumenEPP />} />
